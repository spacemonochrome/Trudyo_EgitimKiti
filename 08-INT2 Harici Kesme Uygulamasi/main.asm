...
;interrupt.c,7 :: 		}
L_Interrupt73:
;interrupt.c,9 :: 		if(INT2IF_bit){
	BTFSS       INT2IF_bit+0, BitPos(INT2IF_bit+0) 
	GOTO        L_Interrupt74
;interrupt.c,10 :: 		INT2IF_bit=0;
	BCF         INT2IF_bit+0, BitPos(INT2IF_bit+0) 
;interrupt.c,11 :: 		LED=!LED;
...
;main.c,9 :: 		InitMCU();
	CALL        _InitMCU+0, 0
;main.c,11 :: 		INT2E_bit=1;    // INT2 dis kesme kaynagini aktif ediyoruz. INT0 ve INT1'de ayri ayri kullanilabilir.
	BSF         INT2E_bit+0, BitPos(INT2E_bit+0) 
;main.c,14 :: 		INTEDG2_bit=1;  // Kesme duselen kenarda olusacak
	BSF         INTEDG2_bit+0, BitPos(INTEDG2_bit+0) 
;main.c,16 :: 		Lcd_Out(1,1,"8.INT2 Dis Kesme");         // Ekranda 1.satir 1.sütundan itibaren yaz
	MOVLW       1
	...
	CALL        _Lcd_Out+0, 0
;main.c,17 :: 		Lcd_Out(2,1,"MENU Btn. Basin ");         // Ekranda 2.satir 1.sütundan itibaren yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Out_column+0 
