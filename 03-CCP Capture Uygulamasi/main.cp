#line 1 "C:/Users/uemin/Desktop/GitHub/Trudyo/Program/Development Board/03-CCP Capture Uygulamasi/main.c"

unsigned int i;
unsigned int counter=0;
char txt[7];
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/03-ccp capture uygulamasi/connection.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/03-ccp capture uygulamasi/function.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/03-ccp capture uygulamasi/display.c"
char getChar(char c){
 switch(c){
 case 'A': return 0xDE;
 case 'B': return 0xF4;
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/03-ccp capture uygulamasi/initialize.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/03-ccp capture uygulamasi/interrupt.c"
void Interrupt(){
 ...
 if(CCP2IE_bit && CCP2IF_bit){
 counter++;
 CCP2IF_bit=0;
 }
}
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/03-ccp capture uygulamasi/ds18b20.c"
...
#line 13 "C:/Users/uemin/Desktop/GitHub/Trudyo/Program/Development Board/03-CCP Capture Uygulamasi/main.c"
void main() {
 InitMCU();

 Lcd_Out(1,1,"3.CCP Capture   ");
 Lcd_Out(2,1,"Capture Cnt:   0");
