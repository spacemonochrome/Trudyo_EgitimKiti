...
;main.c,9 :: 		InitMCU();
	CALL        _InitMCU+0, 0
;main.c,13 :: 		Lcd_Out(1,1,"11.Timer Sayici ");         // Ekranda 1.satir 1.sütundan itibaren yaz
	MOVLW       1
	...
	CALL        _Lcd_Out+0, 0
;main.c,14 :: 		Lcd_Out(2,1,"Uygulamasi      ");         // Ekranda 2.satir 1.sütundan itibaren yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Out_column+0 
	...
	MOVWF       FARG_Lcd_Out_text+1 
	CALL        _Lcd_Out+0, 0
;main.c,16 :: 		T1CON=0b10000001; // [TMR1CS1][TMR1CS2][T1CKPS1][T1CKPS0][SOSCEN][T1SYNC][RD16][TMR1ON]
	MOVLW       129
	MOVWF       T1CON+0 
;main.c,24 :: 		TMR1L=0;          // Sayaci sifirla
	CLRF        TMR1L+0 
;main.c,25 :: 		while(1){
L_main76:
;main.c,26 :: 		PrintInt(TMR1L);  // Sayaci ekrana yaz
	MOVF        TMR1L+0, 0 
	MOVWF       FARG_PrintInt_number+0 
	CALL        _PrintInt+0, 0
;main.c,28 :: 		if(TMR1L>99)      // Sayac 99'dan buyuk ise
	MOVF        TMR1L+0, 0 
	SUBLW       99
	BTFSC       STATUS+0, 0 
	GOTO        L_main78
;main.c,29 :: 		TMR1L=0;        // sifirla
	CLRF        TMR1L+0 
L_main78:
;main.c,30 :: 		}
	GOTO        L_main76
