#line 1 "C:/Users/uemin/Desktop/GitHub/Trudyo/Program/Development Board/16-Sifreli Kilit Uygulamasi/main.c"
unsigned int p0=0;
unsigned int p1=0;
unsigned int p2=0;
unsigned int p3=0;
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/16-sifreli kilit uygulamasi/connection.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/16-sifreli kilit uygulamasi/function.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/16-sifreli kilit uygulamasi/display.c"
char getChar(char c){
 switch(c){
 case 'A': return 0xDE;
 case 'B': return 0xF4;
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/16-sifreli kilit uygulamasi/initialize.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/16-sifreli kilit uygulamasi/interrupt.c"
void Interrupt(){
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/16-sifreli kilit uygulamasi/ds18b20.c"
...
#line 15 "C:/Users/uemin/Desktop/GitHub/Trudyo/Program/Development Board/16-Sifreli Kilit Uygulamasi/main.c"
void main() {
 InitMCU();

 Lcd_Out(1,1,"14.Sifreli Kilit");
 Lcd_Out(2,1,"Sifre:          ");
 ...
 if(password==(p0*1000+p1*100+p2*10+p3)){
 LED04=1;
 RELAY=1;
 }
 else{
 ...
 LED08=0;
 RELAY=0;
 p3=0; Lcd_Chr(2,16,p3+48);
 p2=0; Lcd_Chr(2,15,p2+48);
 p1=0; Lcd_Chr(2,14,p1+48);
 p0=0; Lcd_Chr(2,13,p0+48);
 Lcd_Cmd(_LCD_MOVE_CURSOR_LEFT);
 }

 if(!BUTTON_UP){
 switch (position){
 case 0: if(p0<9) p0++; break;
 case 1: if(p1<9) p1++; break;
 case 2: if(p2<9) p2++; break;
 case 3: if(p3<9) p3++; break;
 }
 }

 if(!BUTTON_DOWN){
 switch(position){
 case 0: if(p0>0) p0--; break;
 case 1: if(p1>0) p1--; break;
 case 2: if(p2>0) p2--; break;
 case 3: if(p3>0) p3--; break;
 }
 }

 switch(position){
 case 0: Lcd_Chr(2,13,p0+48); break;
 case 1: Lcd_Chr(2,14,p1+48); break;
 case 2: Lcd_Chr(2,15,p2+48); break;
 case 3: Lcd_Chr(2,16,p3+48); break;
 }
