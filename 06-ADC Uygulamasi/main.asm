...
;function.c,85 :: 		PORTI0_bit=DIPSW;
	...
	GOTO        L__UpdateExternalPorts81
	BCF         _PORTI+0, 0 
	GOTO        L__UpdateExternalPorts82
L__UpdateExternalPorts81:
	BSF         _PORTI+0, 0 
...
;main.c,11 :: 		InitMCU();
	CALL        _InitMCU+0, 0
;main.c,13 :: 		Lcd_Out(1,1,"6.ADC Uygulamasi");         // Ekranda 1.satir 1.sütundan itibaren yaz
	MOVLW       1
	...
	CALL        _Lcd_Out+0, 0
;main.c,14 :: 		Lcd_Out(2,1,"T1:0000  T2:0000");         // Ekranda 2.satir 1.sütundan itibaren yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Out_column+0 
...
;main.c,16 :: 		while(1){
L_main76:
;main.c,17 :: 		t1=ADC_Read(1);                        // Trimpot1'in degerini Analog 1.kanaldan oku ve t1'e yaz
	MOVLW       1
	...
	MOVF        R1, 0 
	MOVWF       _t1+1 
;main.c,18 :: 		t2=ADC_Read(3);                        // Trimpot2'nin degerini Analog 2.kanaldan oku ve t2'ye yaz
	MOVLW       3
	MOVWF       FARG_ADC_Read_channel+0 
	CALL        _ADC_Read+0, 0
	MOVF        R0, 0 
	...
	MOVF        R1, 0 
	MOVWF       _t2+1 
;main.c,37 :: 		Lcd_Chr(2,4,(t1/1000+48));             // Ekranda 2.satir 4.sütuna yaz
	MOVLW       2
	...
	CALL        _Lcd_Chr+0, 0
;main.c,38 :: 		Lcd_Chr(2,5,((t1%1000)/100+48));       // Ekranda 2.satir 5.sütuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       5
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,39 :: 		Lcd_Chr(2,6,((t1%100)/10+48));         // Ekranda 2.satir 6.sütuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       6
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,40 :: 		Lcd_Chr(2,7,(t1%10+48));               // Ekranda 2.satir 7.sütuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       7
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,42 :: 		Lcd_Chr(2,13,(t2/1000+48));            // Ekranda 2.satir 13.sütuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       13
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,43 :: 		Lcd_Chr(2,14,((t2%1000)/100+48));      // Ekranda 2.satir 14.sütuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       14
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,44 :: 		Lcd_Chr(2,15,((t2%100)/10+48));        // Ekranda 2.satir 15.sütuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       15
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,45 :: 		Lcd_Chr(2,16,(t2%10+48));              // Ekranda 2.satir 16.sütuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       16
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,47 :: 		wait(100);                             // 100ms bekleme
	MOVLW       100
