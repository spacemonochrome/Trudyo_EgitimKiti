#line 1 "C:/Users/uemin/Desktop/GitHub/Trudyo/Program/Development Board/10-PORTB Degisiklik Kesmesmesi ile Sayici Uygulamasi/main.c"
unsigned short number=0;
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/10-portb degisiklik kesmesmesi ile sayici uygulamasi/connection.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/10-portb degisiklik kesmesmesi ile sayici uygulamasi/function.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/10-portb degisiklik kesmesmesi ile sayici uygulamasi/display.c"
char getChar(char c){
 switch(c){
 case 'A': return 0xDE;
 case 'B': return 0xF4;
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/10-portb degisiklik kesmesmesi ile sayici uygulamasi/initialize.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/10-portb degisiklik kesmesmesi ile sayici uygulamasi/interrupt.c"
void Interrupt(){
 ...
 if(!BUTTON_UP && number<99)
 number++;

 if(!BUTTON_DOWN && number>0)
 number--;
 ...
 while(!BUTTON_OK || !BUTTON_UP || !BUTTON_DOWN);

 IOCIF_bit=0;
 }
}
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/10-portb degisiklik kesmesmesi ile sayici uygulamasi/ds18b20.c"
...
#line 10 "C:/Users/uemin/Desktop/GitHub/Trudyo/Program/Development Board/10-PORTB Degisiklik Kesmesmesi ile Sayici Uygulamasi/main.c"
void main() {
 InitMCU();
 IOCIE_bit=1;
 IOCB4_bit=0;
 ...
 Lcd_Out(1,1,"10.PORTB Dgsklik");
 Lcd_Out(2,1,"Kesm. ile sayici");
