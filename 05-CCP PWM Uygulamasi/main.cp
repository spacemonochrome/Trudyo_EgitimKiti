#line 1 "C:/Users/uemin/Desktop/GitHub/Trudyo/Program/Development Board/05-CCP PWM Uygulamasi/main.c"
...
char txt[7];
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/05-ccp pwm uygulamasi/connection.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/05-ccp pwm uygulamasi/function.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/05-ccp pwm uygulamasi/display.c"
char getChar(char c){
 switch(c){
 case 'A': return 0xDE;
 case 'B': return 0xF4;
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/05-ccp pwm uygulamasi/initialize.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/05-ccp pwm uygulamasi/interrupt.c"
void Interrupt(){
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/05-ccp pwm uygulamasi/ds18b20.c"
...
#line 15 "C:/Users/uemin/Desktop/GitHub/Trudyo/Program/Development Board/05-CCP PWM Uygulamasi/main.c"
void main() {
 InitMCU();
#line 42 "C:/Users/uemin/Desktop/GitHub/Trudyo/Program/Development Board/05-CCP PWM Uygulamasi/main.c"
 Lcd_Out(1,1,"5.CCP PWM       ");
 Lcd_Out(2,1,"F:5kHz Duty:   0");
 while(1){
 if(!BUTTON_UP && dutyCycle<255){
 dutyCycle+=5;
 PWM1_Set_Duty(dutyCycle);
 wait(100);
 IntToStr(dutyCycle,txt);
 Lcd_Chr(2,13,txt[2]);
 Lcd_Chr(2,14,txt[3]);
 Lcd_Chr(2,15,txt[4]);
 Lcd_Chr(2,16,txt[5]);
 ...
 else if(!BUTTON_DOWN && dutyCycle>0){
 dutyCycle-=5;
 PWM1_Set_Duty(dutyCycle);
 wait(100);
 IntToStr(dutyCycle,txt);
