...
;initialize.c,40 :: 		Lcd_Cmd(_LCD_CLEAR);
	...
	MOVWF       FARG_Lcd_Cmd_out_char+0 
	CALL        _Lcd_Cmd+0, 0
;initialize.c,42 :: 		PWM1_Init(5000);
	BSF         T2CON+0, 0, 0
	BSF         T2CON+0, 1, 0
	MOVLW       149
	MOVWF       PR2+0, 0
	CALL        _PWM1_Init+0, 0
;initialize.c,43 :: 		PWM1_Set_Duty(0);
	CLRF        FARG_PWM1_Set_Duty_new_duty+0 
	CALL        _PWM1_Set_Duty+0, 0
;initialize.c,44 :: 		PWM1_Start();
...
;main.c,16 :: 		InitMCU();
	CALL        _InitMCU+0, 0
;main.c,42 :: 		Lcd_Out(1,1,"5.CCP PWM       ");         // Ekranda 1.satir 1.sütundan itibaren yaz
	MOVLW       1
	...
	CALL        _Lcd_Out+0, 0
;main.c,43 :: 		Lcd_Out(2,1,"F:5kHz Duty:   0");         // Ekranda 2.satir 1.sütundan itibaren yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Out_column+0 
	...
	MOVWF       FARG_Lcd_Out_text+1 
	CALL        _Lcd_Out+0, 0
;main.c,44 :: 		while(1){                                // Sonsuz dongu
L_main76:
;main.c,45 :: 		if(!BUTTON_UP && dutyCycle<255){       // UP butonuna basilmis ise ve dutyCycle degeri 255'ten kucuk ise
	...
	GOTO        L_main80
L__main90:
;main.c,46 :: 		dutyCycle+=5;                        // dutyCycle degerini bes arttir
	MOVLW       5
	ADDWF       _dutyCycle+0, 0 
	MOVWF       R0 
	MOVF        R0, 0 
	MOVWF       _dutyCycle+0 
;main.c,47 :: 		PWM1_Set_Duty(dutyCycle);            // PWM Duty degerini guncelle
	MOVF        R0, 0 
	MOVWF       FARG_PWM1_Set_Duty_new_duty+0 
	CALL        _PWM1_Set_Duty+0, 0
;main.c,48 :: 		wait(100);                           // 100ms bekle -> delay_ms(100) fonksiyonu esdegeri
	MOVLW       100
	MOVWF       FARG_wait_time+0 
	MOVLW       0
	MOVWF       FARG_wait_time+1 
	CALL        _wait+0, 0
;main.c,49 :: 		IntToStr(dutyCycle,txt);             // Sayac degerini txt dizisine karakter karakter yaz
	MOVF        _dutyCycle+0, 0 
	...
	CALL        _IntToStr+0, 0
;main.c,50 :: 		Lcd_Chr(2,13,txt[2]);                // 1.karakteri 13.sutuna yaz
	MOVLW       2
	...
	CALL        _Lcd_Chr+0, 0
;main.c,51 :: 		Lcd_Chr(2,14,txt[3]);                // 2.karakteri 14.sutuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       14
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,52 :: 		Lcd_Chr(2,15,txt[4]);                // 3.karakteri 15.sutuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       15
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,53 :: 		Lcd_Chr(2,16,txt[5]);                // 4.karakteri 16.sutuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       16
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,54 :: 		while(!BUTTON_UP);                   // Butona hala basili ise buton birakilana kadar bekle
L_main81:
	BTFSC       RB6_bit+0, BitPos(RB6_bit+0) 
	GOTO        L_main82
	GOTO        L_main81
...
;main.c,55 :: 		}
	GOTO        L_main83
L_main80:
;main.c,56 :: 		else if(!BUTTON_DOWN && dutyCycle>0){  // DOWN butonuna basilmis ise ve dutyCycle degeri 0'dan buyuk ise
	...
	GOTO        L_main86
L__main89:
;main.c,57 :: 		dutyCycle-=5;                        // dutyCycle degerini bes azalt
	MOVLW       5
	SUBWF       _dutyCycle+0, 0 
	MOVWF       R0 
	MOVF        R0, 0 
	MOVWF       _dutyCycle+0 
;main.c,58 :: 		PWM1_Set_Duty(dutyCycle);            // PWM Duty degerini guncelle
	MOVF        R0, 0 
	MOVWF       FARG_PWM1_Set_Duty_new_duty+0 
	CALL        _PWM1_Set_Duty+0, 0
;main.c,59 :: 		wait(100);                           // 100ms bekle -> delay_ms(100) fonksiyonu esdegeri
	MOVLW       100
	MOVWF       FARG_wait_time+0 
	MOVLW       0
	MOVWF       FARG_wait_time+1 
	CALL        _wait+0, 0
;main.c,60 :: 		IntToStr(dutyCycle,txt);             // Sayac degerini txt dizisine karakter karakter yaz
	MOVF        _dutyCycle+0, 0 
	MOVWF       FARG_IntToStr_input+0 
	MOVLW       0
	MOVWF       FARG_IntToStr_input+1 
	...
	MOVWF       FARG_IntToStr_output+1 
	CALL        _IntToStr+0, 0
;main.c,61 :: 		Lcd_Chr(2,13,txt[2]);                // 1.karakteri 13.sutuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       13
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,62 :: 		Lcd_Chr(2,14,txt[3]);                // 2.karakteri 14.sutuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       14
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,63 :: 		Lcd_Chr(2,15,txt[4]);                // 3.karakteri 15.sutuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       15
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,64 :: 		Lcd_Chr(2,16,txt[5]);                // 4.karakteri 16.sutuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       16
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,65 :: 		while(!BUTTON_UP);                   // Butona hala basili ise buton birakilana kadar bekle
L_main87:
	BTFSC       RB6_bit+0, BitPos(RB6_bit+0) 
	GOTO        L_main88
	GOTO        L_main87
