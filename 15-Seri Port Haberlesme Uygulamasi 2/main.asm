...
;function.c,85 :: 		PORTI0_bit=DIPSW;
	...
	GOTO        L__UpdateExternalPorts111
	BCF         _PORTI+0, 0 
	GOTO        L__UpdateExternalPorts112
L__UpdateExternalPorts111:
	BSF         _PORTI+0, 0 
L__UpdateExternalPorts112:
;function.c,86 :: 		break;
...
;function.c,88 :: 		PORTI1_bit=DIPSW;
	BTFSC       RA5_bit+0, BitPos(RA5_bit+0) 
	GOTO        L__UpdateExternalPorts113
	BCF         _PORTI+0, 1 
	GOTO        L__UpdateExternalPorts114
L__UpdateExternalPorts113:
	BSF         _PORTI+0, 1 
L__UpdateExternalPorts114:
;function.c,89 :: 		break;
	GOTO        L_UpdateExternalPorts26
...
;function.c,91 :: 		PORTI2_bit=DIPSW;
	BTFSC       RA5_bit+0, BitPos(RA5_bit+0) 
	GOTO        L__UpdateExternalPorts115
	BCF         _PORTI+0, 2 
	GOTO        L__UpdateExternalPorts116
L__UpdateExternalPorts115:
	BSF         _PORTI+0, 2 
L__UpdateExternalPorts116:
;function.c,92 :: 		break;
	GOTO        L_UpdateExternalPorts26
...
;function.c,94 :: 		PORTI3_bit=DIPSW;
	BTFSC       RA5_bit+0, BitPos(RA5_bit+0) 
	GOTO        L__UpdateExternalPorts117
	BCF         _PORTI+0, 3 
	GOTO        L__UpdateExternalPorts118
L__UpdateExternalPorts117:
	BSF         _PORTI+0, 3 
L__UpdateExternalPorts118:
;function.c,95 :: 		break;
	GOTO        L_UpdateExternalPorts26
...
;function.c,97 :: 		PORTI4_bit=DIPSW;
	BTFSC       RA5_bit+0, BitPos(RA5_bit+0) 
	GOTO        L__UpdateExternalPorts119
	BCF         _PORTI+0, 4 
	GOTO        L__UpdateExternalPorts120
L__UpdateExternalPorts119:
	BSF         _PORTI+0, 4 
L__UpdateExternalPorts120:
;function.c,98 :: 		break;
	GOTO        L_UpdateExternalPorts26
...
;function.c,100 :: 		PORTI5_bit=DIPSW;
	BTFSC       RA5_bit+0, BitPos(RA5_bit+0) 
	GOTO        L__UpdateExternalPorts121
	BCF         _PORTI+0, 5 
	GOTO        L__UpdateExternalPorts122
L__UpdateExternalPorts121:
	BSF         _PORTI+0, 5 
L__UpdateExternalPorts122:
...
;interrupt.c,12 :: 		if(UART1_Data_Ready()){   // Eger UART verisi okumaya hazir ise
	...
	BTFSC       STATUS+0, 2 
	GOTO        L_Interrupt77
;interrupt.c,13 :: 		PrintInt(UART1_Read()); // Gelen Sayac degerini ekrana yaz  receivedText[receivedBytes-2]
...
;main.c,13 :: 		InitMCU();
	CALL        _InitMCU+0, 0
;main.c,17 :: 		Lcd_Out(1,1,"13.UART Haberles");         // Ekranda 1.satir 1.sütundan itibaren yaz
	MOVLW       1
	...
	CALL        _Lcd_Out+0, 0
;main.c,18 :: 		Lcd_Out(2,1,"me Uygulamasi   ");         // Ekranda 2.satir 1.sütundan itibaren yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Out_column+0 
...
;main.c,20 :: 		Lcd_Cmd(_LCD_CLEAR);
	...
	MOVWF       FARG_Lcd_Cmd_out_char+0 
	CALL        _Lcd_Cmd+0, 0
;main.c,21 :: 		Lcd_Out(1,1,"Sayac:          ");         // Ekranda 1.satir 1.sütundan itibaren yaz
	MOVLW       1
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Out_column+0 
	...
	MOVWF       FARG_Lcd_Out_text+1 
	CALL        _Lcd_Out+0, 0
;main.c,22 :: 		IntToStrWithZeros(counter,txt);
	MOVF        _counter+0, 0 
...
;main.c,23 :: 		Lcd_Out(1,11,txt);
	...
	MOVWF       FARG_Lcd_Out_text+1 
	CALL        _Lcd_Out+0, 0
;main.c,25 :: 		UART1_Init(9600);                        // UART 9600 baud hizinda hazirlaniyor
	BSF         BAUDCON+0, 3, 0
	MOVLW       4
	MOVWF       SPBRGH+0 
	MOVLW       225
	...
	BSF         TXSTA+0, 2, 0
	CALL        _UART1_Init+0, 0
;main.c,26 :: 		RCIE_bit=1;                              // UART veri alma kesmesi aktif
	BSF         RCIE_bit+0, BitPos(RCIE_bit+0) 
;main.c,28 :: 		while(1){
L_main80:
;main.c,29 :: 		if(!BUTTON_MENU || !BUTTON_OK || !BUTTON_UP || !BUTTON_DOWN){
	...
	GOTO        L_main84
L__main107:
;main.c,30 :: 		if(!BUTTON_MENU && counter>=10)
...
L__main137:
	...
	GOTO        L_main87
L__main106:
;main.c,31 :: 		counter-=10;                           // Sayaci 10 azalt
	MOVLW       10
	SUBWF       _counter+0, 1 
	MOVLW       0
	SUBWFB      _counter+1, 1 
L_main87:
;main.c,32 :: 		if(!BUTTON_OK && counter<=89)
...
L__main138:
	...
	GOTO        L_main90
L__main105:
;main.c,33 :: 		counter+=10;                           // Sayaci 10 arttir
	MOVLW       10
	ADDWF       _counter+0, 1 
	MOVLW       0
	ADDWFC      _counter+1, 1 
L_main90:
;main.c,34 :: 		if(!BUTTON_UP && counter<99)
...
L__main139:
	...
	GOTO        L_main93
L__main104:
;main.c,35 :: 		counter++;                             // Sayaci bir arttirma
	INFSNZ      _counter+0, 1 
	INCF        _counter+1, 1 
L_main93:
;main.c,36 :: 		if(!BUTTON_DOWN && counter>0)
...
L__main140:
	...
	GOTO        L_main96
L__main103:
;main.c,37 :: 		counter--;                             // Sayaci bir azaltma
	MOVLW       1
	SUBWF       _counter+0, 1 
	MOVLW       0
	SUBWFB      _counter+1, 1 
...
;main.c,42 :: 		UART1_Write(counter);                    // Sayac verisini gonder
	MOVF        _counter+0, 0 
	MOVWF       FARG_UART1_Write_data_+0 
	CALL        _UART1_Write+0, 0
;main.c,45 :: 		IntToStrWithZeros(counter,txt);
	MOVF        _counter+0, 0 
	MOVWF       FARG_IntToStrWithZeros_input+0 
	MOVF        _counter+1, 0 
	MOVWF       FARG_IntToStrWithZeros_input+1 
...
;main.c,46 :: 		Lcd_Out(1,11,txt);
	...
	MOVWF       FARG_Lcd_Out_text+1 
	CALL        _Lcd_Out+0, 0
;main.c,48 :: 		wait(100);                               // 100ms bekleme
	MOVLW       100
	MOVWF       FARG_wait_time+0 
	MOVLW       0
	MOVWF       FARG_wait_time+1 
	CALL        _wait+0, 0
;main.c,51 :: 		while(!BUTTON_MENU || !BUTTON_OK || !BUTTON_UP || !BUTTON_DOWN);
L_main97:
	BTFSS       RB2_bit+0, BitPos(RB2_bit+0) 
	GOTO        L__main102
	BTFSS       RB5_bit+0, BitPos(RB5_bit+0) 
