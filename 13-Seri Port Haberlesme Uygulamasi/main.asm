...
;main.c,15 :: 		InitMCU();
	CALL        _InitMCU+0, 0
;main.c,19 :: 		Lcd_Out(1,1,"13.UART Haberles");         // Ekranda 1.satir 1.sütundan itibaren yaz
	MOVLW       1
	...
	CALL        _Lcd_Out+0, 0
;main.c,20 :: 		Lcd_Out(2,1,"me Uygulamasi   ");         // Ekranda 2.satir 1.sütundan itibaren yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Out_column+0 
	...
	MOVWF       FARG_Lcd_Out_text+1 
	CALL        _Lcd_Out+0, 0
;main.c,22 :: 		wait(2000);                              // 2 saniye bekleme
	MOVLW       208
	MOVWF       FARG_wait_time+0 
	MOVLW       7
	MOVWF       FARG_wait_time+1 
	CALL        _wait+0, 0
;main.c,23 :: 		Lcd_Cmd(_LCD_CLEAR);
	MOVLW       1
	MOVWF       FARG_Lcd_Cmd_out_char+0 
	CALL        _Lcd_Cmd+0, 0
...
;main.c,32 :: 		while(1){
L_main83:
;main.c,33 :: 		receivedBytes=0;                       // Alinan veri sayacimizi sifirliyoruz
	CLRF        _receivedBytes+0 
;main.c,34 :: 		UART1_Write_Text("Merhaba Dunya!  ");  // 16 karakter veri gonderiyoruz
	MOVLW       ?lstr3_main+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr3_main+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;main.c,35 :: 		UART1_Write_Text("Sayac:    ");        // 16 karakter veri gonderiyoruz
	MOVLW       ?lstr4_main+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr4_main+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;main.c,37 :: 		counter++;                             // Sayaci bir arttirma
	INFSNZ      _counter+0, 1 
	INCF        _counter+1, 1 
;main.c,38 :: 		IntToStrWithZeros(counter,txt);        // Sayaci metin formatina cevirme
	MOVF        _counter+0, 0 
...
;main.c,39 :: 		UART1_Write_Text(txt);                 // 6 karakter veri gonderiyoruz
	MOVLW       _txt+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(_txt+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;main.c,44 :: 		for(i=0;i<16;i++){
	CLRF        _i+0 
L_main85:
	MOVLW       16
	SUBWF       _i+0, 0 
	BTFSC       STATUS+0, 0 
	GOTO        L_main86
;main.c,45 :: 		Lcd_Chr(1,i+1,receivedText[i]);      // i=0 icin LCD_OUT(1,1,... olmalidir
	MOVLW       1
	...
	CALL        _Lcd_Chr+0, 0
;main.c,46 :: 		Lcd_Chr(2,i+1,receivedText[i+16]);   // i+1 ler bu sebeple eklenmistir
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVF        _i+0, 0 
	ADDLW       1
...
;main.c,51 :: 		receivedText[i]=' ';
	GOTO        L_main88
L_main89:
;main.c,53 :: 		wait(1000);                              // 1 saniye bekleme
	MOVLW       232
	MOVWF       FARG_wait_time+0 
	MOVLW       3
	MOVWF       FARG_wait_time+1 
