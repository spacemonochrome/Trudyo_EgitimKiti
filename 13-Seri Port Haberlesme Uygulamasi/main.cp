#line 1 "C:/Users/uemin/Desktop/GitHub/Trudyo/Program/Development Board/13-Seri Port Haberlesme Uygulamasi/main.c"
char receivedText[32];
unsigned short receivedBytes=0;
unsigned int counter=0;
char txt[7];
unsigned short i;
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/13-seri port haberlesme uygulamasi/connection.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/13-seri port haberlesme uygulamasi/function.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/13-seri port haberlesme uygulamasi/display.c"
char getChar(char c){
 switch(c){
 case 'A': return 0xDE;
 case 'B': return 0xF4;
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/13-seri port haberlesme uygulamasi/initialize.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/13-seri port haberlesme uygulamasi/interrupt.c"
void Interrupt(){
 ...
 RCIF_bit=0;
 if(UART1_Data_Ready()){
 receivedText[receivedBytes]=UART1_Read();
 receivedBytes++;
 }
 }
}
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/13-seri port haberlesme uygulamasi/ds18b20.c"
...
#line 14 "C:/Users/uemin/Desktop/GitHub/Trudyo/Program/Development Board/13-Seri Port Haberlesme Uygulamasi/main.c"
void main() {
 InitMCU();



 Lcd_Out(1,1,"13.UART Haberles");
 Lcd_Out(2,1,"me Uygulamasi   ");
 ...
 while(1){
 receivedBytes=0;
 UART1_Write_Text("Merhaba Dunya!  ");
 UART1_Write_Text("Sayac:    ");
 ...
 for(i=0;i<16;i++){
 Lcd_Chr(1,i+1,receivedText[i]);
 Lcd_Chr(2,i+1,receivedText[i+16]);
 }
