...
;initialize.c,40 :: 		Lcd_Cmd(_LCD_CLEAR);
	...
	MOVWF       FARG_Lcd_Cmd_out_char+0 
	CALL        _Lcd_Cmd+0, 0
;initialize.c,50 :: 		CM1CON0=0b10100001;
	MOVLW       161
	MOVWF       CM1CON0+0 
;initialize.c,51 :: 		}
L_end_InitMCU:
...
;main.c,11 :: 		InitMCU();
	CALL        _InitMCU+0, 0
;main.c,13 :: 		Lcd_Out(1,1,"4.CCP Compare   ");    // Ekranda 1.satir 1.sütundan itibaren yaz
	MOVLW       1
	...
	CALL        _Lcd_Out+0, 0
;main.c,14 :: 		Lcd_Out(2,1,"      T1<T2     ");    // Ekranda 2.satir 1.sütundan itibaren yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Out_column+0 
...
;main.c,16 :: 		while(1){
L_main76:
;main.c,17 :: 		if(C1OUT_bit)                     // C1OUT=1 ise C1<C2'dir (Datasheet sy.307 CMxCON register)
	BTFSS       C1OUT_bit+0, BitPos(C1OUT_bit+0) 
	GOTO        L_main78
;main.c,18 :: 		Lcd_Chr(2,9,'<');               // Ekranda 2.satir 9.sütuna tek bir yaz
	MOVLW       2
	...
	GOTO        L_main79
L_main78:
;main.c,20 :: 		Lcd_Chr(2,9,'>');               // Ekranda 2.satir 9.sütuna tek bir yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       9
	MOVWF       FARG_Lcd_Chr_column+0 
