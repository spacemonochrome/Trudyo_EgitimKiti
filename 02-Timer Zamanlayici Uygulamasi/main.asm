...
;interrupt.c,13 :: 		TMR0L	 = 0xE5;
	MOVLW       229
	MOVWF       TMR0L+0 
;interrupt.c,15 :: 		if(number<99)  // Eger sayi 99'dan kucuk ise
	MOVLW       99
	SUBWF       _number+0, 0 
	BTFSC       STATUS+0, 0 
	GOTO        L_Interrupt75
;interrupt.c,16 :: 		number++;    // bir arttir
	INCF        _number+0, 1 
	GOTO        L_Interrupt76
L_Interrupt75:
;interrupt.c,18 :: 		number=0;    // sifir yap
	CLRF        _number+0 
L_Interrupt76:
;interrupt.c,19 :: 		}
L_Interrupt74:
...
;main.c,16 :: 		while(1){
L_main79:
;main.c,17 :: 		Lcd_Out(1,1,"2.TMR0 Zamanlayici");    // Ekranda 1.satir 1.sütundan itibaren yaz
	MOVLW       1
	...
	CALL        _Lcd_Out+0, 0
;main.c,19 :: 		if(!BUTTON_MENU)                     // Eger Menu butonuna basilirsa
	BTFSC       RB2_bit+0, BitPos(RB2_bit+0) 
	GOTO        L_main81
;main.c,20 :: 		number=0;                          // sayiyi sifir yap
	CLRF        _number+0 
L_main81:
;main.c,22 :: 		PrintInt(number);                    // 7 Segment ekrana sayiyi yazdir
	MOVF        _number+0, 0 
	MOVWF       FARG_PrintInt_number+0 
	CALL        _PrintInt+0, 0
;main.c,23 :: 		delay_ms(50);                        // 50ms bekleme
	MOVLW       4
	MOVWF       R11, 0
	MOVLW       12
	MOVWF       R12, 0
