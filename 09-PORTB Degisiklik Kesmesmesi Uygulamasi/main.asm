...
;function.c,85 :: 		PORTI0_bit=DIPSW;
	...
	GOTO        L__UpdateExternalPorts80
	BCF         _PORTI+0, 0 
	GOTO        L__UpdateExternalPorts81
L__UpdateExternalPorts80:
	BSF         _PORTI+0, 0 
...
;interrupt.c,9 :: 		if(IOCIF_bit){
	...
	GOTO        L_Interrupt74
;interrupt.c,10 :: 		IOCIF_bit=0;       // degisiklik kesme bayragini sifirliyoruz.
	BCF         IOCIF_bit+0, BitPos(IOCIF_bit+0) 
;interrupt.c,11 :: 		LED06= RB5_bit;
...
;ds18b20.c,30 :: 		if(tempData>0xF800){
	...
	SUBLW       248
	BTFSS       STATUS+0, 2 
	GOTO        L__ReadDS18B20110
	MOVF        R2, 0 
	SUBLW       0
L__ReadDS18B20110:
	BTFSC       STATUS+0, 0 
	GOTO        L_ReadDS18B2076
...
;main.c,9 :: 		InitMCU();
	CALL        _InitMCU+0, 0
;main.c,10 :: 		IOCIE_bit=1;    // PORTB degisiklik kesmesini aktif ediyoruz.
	BSF         IOCIE_bit+0, BitPos(IOCIE_bit+0) 
;main.c,11 :: 		IOCB4_bit=0;
	BCF         IOCB4_bit+0, BitPos(IOCB4_bit+0) 
;main.c,12 :: 		IOCB5_bit=1;
	BSF         IOCB5_bit+0, BitPos(IOCB5_bit+0) 
;main.c,13 :: 		IOCB6_bit=1;
	BSF         IOCB6_bit+0, BitPos(IOCB6_bit+0) 
;main.c,14 :: 		IOCB7_bit=1;
	BSF         IOCB7_bit+0, BitPos(IOCB7_bit+0) 
;main.c,16 :: 		Lcd_Out(1,1,"9.PORTB Dgsklik.");         // Ekranda 1.satir 1.sütundan itibaren yaz
	MOVLW       1
	...
	CALL        _Lcd_Out+0, 0
;main.c,17 :: 		Lcd_Out(2,1,"Kesmesi         ");         // Ekranda 2.satir 1.sütundan itibaren yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Out_column+0 
