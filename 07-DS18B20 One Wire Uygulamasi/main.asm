...
;main.c,14 :: 		InitMCU();
	CALL        _InitMCU+0, 0
;main.c,32 :: 		Lcd_Out(1,1,"7.DS18B20 Uyg.  ");         // Ekranda 1.satir 1.sütundan itibaren yaz
	MOVLW       1
	...
	CALL        _Lcd_Out+0, 0
;main.c,33 :: 		Lcd_Out(2,1,"1:123 2:123 T:25");         // Ekranda 2.satir 1.sütundan itibaren yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Out_column+0 
...
;main.c,35 :: 		while(1){
L_main76:
;main.c,36 :: 		t1=ADC_Read(1)/10;                     // Trimpot1'in degerini Analog 1.kanaldan oku ve t1'e yaz    Sogutma icin klima
	MOVLW       1
	...
	MOVF        R1, 0 
	MOVWF       _t1+1 
;main.c,37 :: 		t2=ADC_Read(3)/10;                     // Trimpot2'nin degerini Analog 2.kanaldan oku ve t2'ye yaz  Yüksek sicaklik alarm
	MOVLW       3
	MOVWF       FARG_ADC_Read_channel+0 
	CALL        _ADC_Read+0, 0
	MOVLW       10
	...
	MOVF        R1, 0 
	MOVWF       _t2+1 
;main.c,38 :: 		t3=ReadDS18B20();                      // DS18B20.c kutuphane dosyasi icerisindeki ReadDS18B20 fonksiyonu ile sicaklik degerini getir
	CALL        _ReadDS18B20+0, 0
	CALL        _double2word+0, 0
	MOVF        R0, 0 
	MOVWF       _t3+0 
	MOVF        R1, 0 
	MOVWF       _t3+1 
;main.c,41 :: 		Lcd_Chr(2,3,((t1%1000)/100+48));       // Ekranda 2.satir 5.sütuna yaz
	MOVLW       2
	...
	CALL        _Lcd_Chr+0, 0
;main.c,42 :: 		Lcd_Chr(2,4,((t1%100)/10+48));         // Ekranda 2.satir 6.sütuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       4
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,43 :: 		Lcd_Chr(2,5,(t1%10+48));               // Ekranda 2.satir 7.sütuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       5
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,46 :: 		Lcd_Chr(2,9,((t2%1000)/100+48));       // Ekranda 2.satir 5.sütuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       9
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,47 :: 		Lcd_Chr(2,10,((t2%100)/10+48));        // Ekranda 2.satir 6.sütuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       10
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,48 :: 		Lcd_Chr(2,11,(t2%10+48));              // Ekranda 2.satir 7.sütuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       11
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,51 :: 		Lcd_Chr(2,15,((t3%100)/10+48));        // Ekranda 2.satir 6.sütuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       15
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;main.c,52 :: 		Lcd_Chr(2,16,(t3%10+48));              // Ekranda 2.satir 7.sütuna yaz
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       16
	MOVWF       FARG_Lcd_Chr_column+0 
...
;main.c,69 :: 		BUZZER=0;
	BCF         LATA2_bit+0, BitPos(LATA2_bit+0) 
L_main81:
;main.c,71 :: 		wait(100); // 100ms bekleme
	MOVLW       100
	MOVWF       FARG_wait_time+0 
	MOVLW       0
	MOVWF       FARG_wait_time+1 
