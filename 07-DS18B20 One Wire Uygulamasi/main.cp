#line 1 "C:/Users/uemin/Desktop/GitHub/Trudyo/Program/Development Board/07-DS18B20 One Wire Uygulamasi/main.c"
float temp;
unsigned int t3;
char txt[15];
unsigned int t1,t2;
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/07-ds18b20 one wire uygulamasi/connection.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/07-ds18b20 one wire uygulamasi/function.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/07-ds18b20 one wire uygulamasi/display.c"
char getChar(char c){
 switch(c){
 case 'A': return 0xDE;
 case 'B': return 0xF4;
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/07-ds18b20 one wire uygulamasi/initialize.c"
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/07-ds18b20 one wire uygulamasi/interrupt.c"
void Interrupt(){
...
#line 1 "c:/users/uemin/desktop/github/trudyo/program/development board/07-ds18b20 one wire uygulamasi/ds18b20.c"
...
#line 13 "C:/Users/uemin/Desktop/GitHub/Trudyo/Program/Development Board/07-DS18B20 One Wire Uygulamasi/main.c"
void main() {
 InitMCU();
#line 32 "C:/Users/uemin/Desktop/GitHub/Trudyo/Program/Development Board/07-DS18B20 One Wire Uygulamasi/main.c"
 Lcd_Out(1,1,"7.DS18B20 Uyg.  ");
 Lcd_Out(2,1,"1:123 2:123 T:25");
 ...
 Lcd_Chr(2,3,((t1%1000)/100+48));
 Lcd_Chr(2,4,((t1%100)/10+48));
 Lcd_Chr(2,5,(t1%10+48));


 Lcd_Chr(2,9,((t2%1000)/100+48));
 Lcd_Chr(2,10,((t2%100)/10+48));
 Lcd_Chr(2,11,(t2%10+48));


 Lcd_Chr(2,15,((t3%100)/10+48));
 Lcd_Chr(2,16,(t3%10+48));
